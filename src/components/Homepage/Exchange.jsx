...
//           <h1 className="text-4xl italic font-serif font-bold">Exchange Books</h1>
...
//           Explore a wide range of books tailored to your interests and needs.
//         </p>
...
//             </div>
//             <button className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg font-medium transition-all duration-300 shadow-md hover:shadow-lg flex items-center">
//               View All
...
//             Explore a wide range of books tailored to your interests and needs. Exchange your old books for new adventures.
//           </p>
//         </div>

//         {/* Books grid with enhanced card design */}
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
//           {books.map((book) => (
//             <div
//               key={book._id}
...
//                       <div className="bg-indigo-100 text-indigo-700 rounded-full w-8 h-8 flex items-center justify-center font-medium mr-2">
                ...
                <div>
                  ...
                  {book.bookPurpose && (
                    <p className="text-gray-600 mb-1 flex items-center">
                      ...
                      <span className="ml-1 text-gray-700">{book.bookPurpose || "Exchange"}</span>
                    </p>
                  )}
                </div>
